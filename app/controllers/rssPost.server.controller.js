...
var RssPost = require('mongoose').model('RssPost');
var debug = require('debug')('rssPost');
...
exports.findOneRssPost = function(post, incMentions, callback) {

	// console.log("findOneRssPost:" + post.nodeId);
