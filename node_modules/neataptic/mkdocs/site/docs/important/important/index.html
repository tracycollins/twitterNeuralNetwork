<html>
  <head>
    <title>Neataptic.js - Important functions</title>

    <!-- Meta data -->
    <meta charset="UTF-8">

    
    <meta name="description" content="List of important functions in Neataptic">
    

    
    <meta name="keywords" content="train, evolve, neataptic">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-10 col-md-10 col-lg-10 content">
          <h1 style="margin-bottom: 0px;">Important functions</h1>
          <p><a style="text-decoration: none" href="https://github.com/wagenaartje/neataptic/edit/master/mkdocs/templates/docs\important\important.md"><i class="fa fa-github fa-1x"></i> Edit on Github</a></p>
          <hr>
          <ul>
