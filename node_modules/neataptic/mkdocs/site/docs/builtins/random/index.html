<html>
  <head>
    <title>Neataptic.js - Random</title>

    <!-- Meta data -->
    <meta charset="UTF-8">

    
    <meta name="description" content="How to use the Random model network in Neataptic">
    

    
    <meta name="keywords" content="recurrent, feed-forward, gates, neural-network, random, architecture">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-10 col-md-10 col-lg-10 content">
          <h1 style="margin-bottom: 0px;">Random</h1>
          <p><a style="text-decoration: none" href="https://github.com/wagenaartje/neataptic/edit/master/mkdocs/templates/docs\builtins\random.md"><i class="fa fa-github fa-1x"></i> Edit on Github</a></p>
          <hr>
          <p>A random network is similar to a liquid network. This network will start of with a given pool of nodes, and will then create random connections between them. This network is really only useful for the initialization of the population for a genetic algorithm.</p>
<pre><code class="javascript">new Architect.Random(input_size, hidden_size, output_size, options);
</code></pre>

<ul>
<li><code>input_size</code> : amount of input nodes</li>
<li><code>hidden_size</code> : amount of nodes inbetween input and output</li>
<li><code>output_size</code> : amount of output nodes</li>
</ul>
<p>Options:
<em> <code>connections</code> : amount of connections (default is <code>2 * hidden_size</code>, should always be bigger than <code>hidden_size</code>!)
</em> <code>backconnections</code> : amount of recurrent connections (default is <code>0</code>)
<em> <code>selfconnections</code> : amount of selfconnections (default is <code>0</code>)
</em> <code>gates</code> : amount of gates (default is <code>0</code>)</p>
<p>For example:</p>
<pre><code class="javascript">var network = Architect.Random(1, 20, 2, {
  connections: 40,
  gates: 4,
  selfconnections: 4
});
...
<p>will produce:</p>
<p><img src="https://i.gyazo.com/a6a8076ce043f4892d0a77c6f816f0c0.png" width="100%"/></p>
        </div>
