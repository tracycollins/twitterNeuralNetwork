<html>
  <head>
    <title>Neataptic.js - Built-in networks</title>
      ...
      <div class="row">
        ...
        <div class="col-sm-2 col-md-2 col-lg-2">
            ...
            <ul id="sidebar" class="nav nav-stacked affix">
                      ...
                      <li><a href="./">Built-in networks</a></li>
                      <ul>
        ...
        <div class="col-sm-10 col-md-10 col-lg-10 content">
          <h1 style="margin-bottom: 0px;">Built-in networks</h1>
          <p><a style="text-decoration: none" href="https://github.com/wagenaartje/neataptic/edit/master/mkdocs/templates/docs\builtins\builtins.md"><i class="fa fa-github fa-1x"></i> Edit on Github</a></p>
          <hr>
          <p>If you are unfamiliar with building networks layer by layer, you can use the
...
moment, Neataptic offers 6 preconfigured networks.</p>
<ul>
<li><a href="../gru/">GRU</a></li>
<li><a href="../hopfield/">Hopfield</a></li>
