...
<p>A quick explanation of each argument:
<em> <code>inputSize</code>: the amount of input nodes
</em> <code>hiddenLayers</code>: an array containing hidden layer sizes, e.g. <code>[10,20,10]</code>. If only one hidden layer, can be a number (of nodes)
<em> <code>outputSize</code>: the amount of output nodes
</em> <code>previousInput</code>: the amount of previous inputs you want it to remember
* <code>previousOutput</code>: the amount of previous outputs you want it to remember</p>
<p>Example:</p>
