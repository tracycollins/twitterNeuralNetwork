<html>
  <head>
    <title>Neataptic.js - Tutorials</title>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-10 col-md-10 col-lg-10 content">
          <h1 style="margin-bottom: 0px;">Tutorials</h1>
          <p><a style="text-decoration: none" href="https://github.com/wagenaartje/neataptic/edit/master/mkdocs/templates/docs\tutorials\tutorials.md"><i class="fa fa-github fa-1x"></i> Edit on Github</a></p>
          <hr>
          <p>In order to get you started on Neataptic, a few tutorials have been written that
give a basic overview on how to create, train and evolve your networks. It is
recommended to read all of them before you start digging in your own project.</p>
<ul>
...
<p>If you have any questions, feel free to create an issue <a href="https://github.com/wagenaartje/neataptic/issues">here</a>.
If you feel like anything is missing, feel free to create a pull request!</p>
        </div>
