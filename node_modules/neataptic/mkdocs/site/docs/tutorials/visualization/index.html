<html>
  <head>
    <title>Neataptic.js - Visualization</title>

    <!-- Meta data -->
    <meta charset="UTF-8">

    
    <meta name="description" content="A simple tutorial on how to visualize neural-networks in Neataptic">
    

    
    <meta name="keywords" content="graph, model, neural-network, visualize, nodes, connections">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-10 col-md-10 col-lg-10 content">
          <h1 style="margin-bottom: 0px;">Visualization</h1>
          <p><a style="text-decoration: none" href="https://github.com/wagenaartje/neataptic/edit/master/mkdocs/templates/docs\tutorials\visualization.md"><i class="fa fa-github fa-1x"></i> Edit on Github</a></p>
          <hr>
          <p>This is a step-by-step tutorial aimed to teach you how to create and visualise neural networks using Neataptic.</p>
<p><strong>Step 1</strong>
Create a javascript file. Name it anything you want. But make sure to start it off with the following:</p>
<pre><code class="javascript">var Node = neataptic.Node;
...
<p>This makes the whole developing a whole lot easier</p>
<p><strong>Step 2</strong>
Create a html file. Copy and paste this template if you want:</p>
...
<p><strong>Step 3</strong> Create a network. You can do that in any of the following ways:</p>
<pre><code class="javascript">var network = Architect.Random(2, 20, 2, 2);
</code></pre>

<pre><code class="javascript">var network = Architect.Perceptron(2, 10, 10, 2);
</code></pre>

<p>Or if you want to be more advanced, construct your own:</p>
...
<p><strong>Step 4</strong> Retrieve data and draw a graph</p>
<pre><code class="javascript">drawGraph(network.graph(1000, 1000), '.draw');
</code></pre>

<p>See a working example <a href="https://jsfiddle.net/wagenaartje/ch8s9d3e/23/">here</a>!
See more info on graphs <a href="https://github.com/wagenaartje/neataptic/tree/master/graph">here</a>!</p>
        </div>
