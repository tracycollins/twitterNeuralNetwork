<html>
  <head>
    <title>Neataptic.js - Architecture</title>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-10 col-md-10 col-lg-10 content">
          <h1 style="margin-bottom: 0px;">Architecture</h1>
          <p><a style="text-decoration: none" href="https://github.com/wagenaartje/neataptic/edit/master/mkdocs/templates/docs\architecture\architecture.md"><i class="fa fa-github fa-1x"></i> Edit on Github</a></p>
          <hr>
          <p>If you want to built your completely custom neural network; this is the place to be.
You can build your network from the bottom, using nodes and connections, or you can
ease up the process by using groups and layers.</p>
<ul>
