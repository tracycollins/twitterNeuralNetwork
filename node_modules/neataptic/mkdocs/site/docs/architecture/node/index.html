...
<pre><code class="javascript">myNode.propage(learningRate, momentum, target);
</code></pre>

<p>The target argument is optional. The default value of momentum is <code>0</code>. Read more
about momentum on the <a href="../../methods/regularization/">regularization page</a>. For
example, this is how you can train node B to activate 0 when node A activates 1:</p>
