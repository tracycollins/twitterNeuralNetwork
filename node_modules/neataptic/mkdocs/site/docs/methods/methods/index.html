<html>
  <head>
    <title>Neataptic.js - Methods</title>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-10 col-md-10 col-lg-10 content">
          <h1 style="margin-bottom: 0px;">Methods</h1>
          <p><a style="text-decoration: none" href="https://github.com/wagenaartje/neataptic/edit/master/mkdocs/templates/docs\methods\methods.md"><i class="fa fa-github fa-1x"></i> Edit on Github</a></p>
          <hr>
          <p>There are <strong>a lot</strong> of different methods for everything in Neataptic. This allows
the complete customization of your networks and algorithms. If you feel like any
method or function should be added, feel free to create an issue or a pull request.</p>
<ul>
