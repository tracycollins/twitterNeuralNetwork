...
<p>When removing a node, you remove the connections and intialise new ones. Setting this option to true will make sure if the removed connections were gated, so will the new ones be.</p>
<p>&zwnj;</p>
<pre><code class="js">Methods.Mutation.MOD_WEIGHT.min // default: -1
Methods.Mutation.MOD_WEIGHT.max // default: 1
</code></pre>

<p>Sets the upper and lower bounds of the modifcation of connection weights.</p>
<p>&zwnj;</p>
<pre><code class="js">Methods.Mutation.MOD_BIAS.min // default: -1
Methods.Mutation.MOD_BIAS.max // default: 1
</code></pre>

<p>Sets the upper and lower bounds of the modifcation of neuron biases.</p>
<p>&zwnj;</p>
