<html>
  <head>
    <title>Neataptic.js - Regularization</title>

    <!-- Meta data -->
    <meta charset="UTF-8">

    
    <meta name="description" content="List of regularization methods in Neataptic">
    

    
    <meta name="keywords" content="regularization, dropout, neural-network, training, backpropagation, momentum">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-10 col-md-10 col-lg-10 content">
          <h1 style="margin-bottom: 0px;">Regularization</h1>
          <p><a style="text-decoration: none" href="https://github.com/wagenaartje/neataptic/edit/master/mkdocs/templates/docs\methods\regularization.md"><i class="fa fa-github fa-1x"></i> Edit on Github</a></p>
          <hr>
          <p>Regularization helps to keep weights and/or biases small in your network. Some
regularization methods also make sure that you are not overfitting your data.</p>
<h3 id="dropout">Dropout</h3>
<p>Enabling dropout will randomly set the activation of a neuron in a network to <code>0</code>
with a given probability.</p>
<p><img alt="" src="http://cs231n.github.io/assets/nn2/dropout.jpeg" /></p>
<p>Only use dropout when you are working with large datasets that may show some noise.
...
<p>Setting the dropout to <code>0.4</code> means that 40% of the neurons will be dropped out every training iteration. Please note that Neataptic has no layered network architecture, so dropout applies to the complete hidden area.</p>
<h3 id="momentum">Momentum</h3>
<p>Momentum simply adds a fraction m of the previous weight update to the current one.
...
minimum with huge steps! Read more about it <a href="https://www.willamette.edu/~gorr/classes/cs449/momrate.html">here</a>.</p>
<p><img alt="Momentum weight update equation" src="https://www.willamette.edu/~gorr/classes/cs449/equations/momentum.gif" /></p>
<p>you can use this option during training:</p>
<pre><code class="javascript">myNetwork.train(myTrainingSet, {
  error: 0.03,
  iterations: 1000,
  rate: 0.3,
...
<p>Setting the momentum to <code>0.9</code> will mean that 90% of the previous weight change
will be included in the current weight change.</p>
        </div>
