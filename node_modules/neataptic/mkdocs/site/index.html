<html>
  <head>
    ...
    <meta name="description" content="Neataptic is the JavaScript neural-network solution.">
    

    
    <meta name="keywords" content="neuro-evolution, neural-network, machine-learning, backpropagation, JavaScript, library">
...
<p>Neataptic offers extremely flexible networks; neurons and synapses can be removed with a single line of code. No fixed architecture is required for neural networks to function at all. An important aspect that Neataptic introduces is the evolution of neural-networks: for every problem, a neural network can be evolved.</p>
<p>Use any of the <strong>6</strong> built-in networks with customizable sizes to create a network:</p>
<pre><code class="javascript">var myNetwork = new Architect.LSTM(1,10,5,1);
</code></pre>

<p>Or built your <strong>own</strong> network with pre-built layers:</p>
<pre><code class="javascript">var input = new Layer.Dense(2);
...
<p>You can even built your network neuron-by-neuron using <b>nodes</b> and <b>groups</b>!</p>
<p><details>
<summary><a href="docs/">Visit the wiki to get started</a></summary>
</details>
<details>
<summary><a href="articles/playground/">or play around with neural networks</a></summary>
</details></p>
<p><img src="https://i.gyazo.com/27e8003df60dbbd21e240a53f8ec093a.png" width="33%"/><img src="https://i.gyazo.com/5325ca9217dbca3151a891739548a01d.png" width="33%"/><img src="https://i.gyazo.com/f566d2364af43dd3a78c8926ed204a51.png" width="33%"/></p>
        </div>
