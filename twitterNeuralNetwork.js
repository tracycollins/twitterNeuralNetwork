...
configuration.maxNeuralNetworkChildern = (process.env.MAX_NEURAL_NETWORK_CHILDREN !== undefined) ? process.env.MAX_NEURAL_NETWORK_CHILDREN : DEFAULT_MAX_NEURAL_NETWORK_CHILDREN;
